...
export const userCard = (
  data: UserCardRequest
): Promise<ApiResponse<UserCardResponse>> => {
  return service({
    url: "/user/card",
    method: "get",
    params: data,
...
export const userChangeInfo = (
  data: UserChangeInfoRequest
): Promise<ApiResponse<undefined>> => {
  return service({
    url: "/user/changeInfo",
    method: "put",
...
export const userChart = (
  data: UserChartRequest
): Promise<ApiResponse<UserChartResponse>> => {
  return service({
    url: "/user/chart",
    method: "get",
    params: data,
...
export const userLoginList = (
  data: UserLoginListRequest
): Promise<ApiResponse<PageResult<Login>>> => {
  return service({
    url: "/user/loginList",
    method: "get",
    params: data,
