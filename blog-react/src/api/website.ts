...
export const websiteNews = (
  data: WebsiteNewsRequest
): Promise<ApiResponse<HotSearchData>> => {
  return service({
    url: "/website/news",
    method: "get",
    params: data,
...
export const websiteCalendar = (): Promise<
  ApiResponse<WebsiteCalendarResponse>
> => {
  return service({
...
export const websiteAddCarousel = (
  data: WebsiteCarouselOperation
...
export const websiteCancelCarousel = (
  data: WebsiteCarouselOperation
): Promise<ApiResponse<undefined>> => {
  return service({
...
export const websiteCreateFooterLink = (
  data: FooterLink
): Promise<ApiResponse<undefined>> => {
  return service({
...
export const websiteDeleteFooterLink = (
  data: FooterLink
): Promise<ApiResponse<undefined>> => {
  return service({
