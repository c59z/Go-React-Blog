...
export const friendLinkInfo = (): Promise<
  ApiResponse<FriendLinkInfoResponse>
> => {
  return service({
    url: "/friendLink/info",
    method: "get",
...
export const friendLinkCreate = (
  data: FriendLinkCreateRequest
...
export const friendLinkDelete = (
  data: FriendLinkDeleteRequest
): Promise<ApiResponse<undefined>> => {
  return service({
...
export const friendLinkUpdate = (
  data: FriendLinkUpdateRequest
): Promise<ApiResponse<undefined>> => {
  return service({
...
export const friendLinkList = (
  data: FriendLinkListRequest
): Promise<ApiResponse<PageResult<FriendLink>>> => {
  return service({
    url: "/friendLink/list",
    method: "get",
    params: data,
