...
export const advertisementInfo = (): Promise<
  ApiResponse<AdvertisementInfoResponse>
> => {
  return service({
...
export const advertisementDelete = (
  data: AdvertisementDeleteRequest
): Promise<ApiResponse<undefined>> => {
  return service({
...
export const advertisementList = (
  data: AdvertisementListRequest
): Promise<ApiResponse<PageResult<Advertisement>>> => {
  return service({
